...
- The topic / week it's for
- The link
- Why it's better (30 seconds of your take)

We favor resources that are **free, self-contained, and project-first**. Paywalled or promotional content is a hard no.

### 📝 Improve wording, add a diagram, clarify a checkpoint
Send a PR. For small edits (typos, one-line clarifications), just push straight to a branch and open the PR. For larger reworks (rewriting a whole phase, adding a new visual), open an issue first so we can align on direction.

### 🌍 Add translations
The roadmap is currently English-only. A translated `README.<lang>.md` is welcome. Link from the top of the main README so people can find it.

### 🎓 Share your journey
Finished a phase? Got a job partway through? Add yourself to a `success-stories.md` (open a PR to create it if it doesn't exist yet). Real names + real projects help the next person believe it's possible.
...
- [ ] I clicked every link I added / changed and confirmed it works
- [ ] I explained *why* in the PR description, not just *what*
- [ ] I updated the `Complete this` column if the resource change affects the checklist
- [ ] I preserved the Mermaid diagrams and phase structure
