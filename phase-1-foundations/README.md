...
> Full context and week-by-week table in the [main README](../README.md#-phase-1--foundations-python--math-for-ai).

## What lives in this folder

As you work through Weeks 1–4, put artifacts here:

```
phase-1-foundations/
├── week-1-python/          # Kaggle Python exercise notebooks
├── week-2-pandas-numpy/    # CSV analysis: 10 questions, 5 charts
├── week-3-linear-algebra/  # NumPy dot product + matrix transform
├── week-4-calculus-stats/  # Gradient descent from scratch (20 lines)
...
- [ ] I can write a Python function and class without looking anything up
- [ ] I can explain what matrix multiplication does to a vector
- [ ] I can answer questions about a CSV using Pandas groupby and filtering
- [ ] I can explain gradient descent in one sentence
